...
const lineFormat = winston.format.printf(({ level, message, timestamp, stack, ...meta }) => {
...
export const logger = winston.createLogger({
    ...
    format: winston.format.combine(winston.format.timestamp({ format: 'YYYY-MM-DD HH:mm:ss.SSS' }), winston.format.errors({ stack: true }), lineFormat),
    transports: [
